...
const Navbar = ({ openPopup }) => {
  ...
  const searchContainerPL = isSearchClicked
    ? "md:pl-[.2vw]"
    : "pl-[16vw] md:pl-[1vw]";
  const searchWidth = isSearchClicked
    ? "w-[88vw] md:w-[21.6vw] justify-start pl-[5vw] md:pl-[1vw] translate-x-[1vw] md:translate-x-[0]"
    : "w-[13vw] md:w-[3vw] justify-center";
    ...
    <div className="h-[15vw] md:h-[6.2vw] flex flex-row justify-between absolute z-20 w-full pr-[3vw] md:pr-0">
      ...
      <div className="w-[90vw] fixed bottom-2 left-[5vw] md:static md:w-1/3 flex justify-center items-center">
        ...
        >
          ...
          >
            <Link to="/allMovies" className="cursor-pointer">
              Movie
            </Link>
            <Link to="/allMovies" className="cursor-pointer">
              Series
      ...
      <div className="w-[60vw] md:w-1/3 flex flex-row items-center justify-end pr-[2vw] gap-[3vw] md:gap-[1vw]">
        ...
        <div className="h-full md:h-[3.4vw] flex flex-row gap-[3vw] md:gap-[.5vw] items-center md:items-start">
          <button
            onClick={openPopup}
            className="cursor-pointer w-[9vw] h-[9vw] md:w-[3.4vw] md:h-[3.4vw] rounded-full overflow-hidden"
          >
            <img className="w-full" src={profilePic} />
          </button>
          <button
            onClick={openPopup}
            className="hidden md:flex md:flex-col text-gray-200 font-semibold text-[4vw] md:text-[1vw] cursor-pointer"
          >
            <p>Aria A</p>
            <p>premium</p>
          </button>
        ...
        <button
          onClick={openPopup}
          className="hidden md:flex cursor-pointer w-[7vw] h-[7vw] md:w-[3vw] md:h-[3vw] justify-center items-center text-[10vw] md:text-[2vw] text-gray-200"
        >
          <IoIosArrowDown />
        </button>
      </div>
              ...
              filteredData.map((item, index) => (
                ...
                >
                  <img
                    src={item.image}
                    alt={item.title}
                    className="w-[10vw] md:w-[2vw] rounded"
                  />
