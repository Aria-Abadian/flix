...
const Footer = () => {
  return (
    <div className="mt-[20vw] md:mt-[10vw] bg-slate-900 md:bg-slate-950 flex flex-col md:flex-row items-center md:items-start md:justify-center p-[10vw] md:p-[2vw] text-center relative z-10">
